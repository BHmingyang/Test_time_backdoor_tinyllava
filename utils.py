...
def get_img_idct_eval(img_ori, batch_delta, image_size, rho, sigma, device, patch_attack=False, delta_mask=None):

    batch_delta = batch_delta.to(device)
    gauss = torch.randn(1, 3, image_size, image_size, device=device) * (sigma / 255)
